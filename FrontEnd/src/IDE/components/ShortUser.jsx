  ...
  return (
    <div className="hidden w-64 h-10 text-center lg:flex justify-end pr-8 items-center relative">
      ...
      >
        ...
        <Link to={'/'} onClick={()=> sessionStorage.clear()} className="h-9 w-full flex items-center justify-start tracking-widest font-semibold text-lg cursor-pointer select-none hover:bg-[#a21751] hover:text-[#ffffff95] transition-colors duration-200 delay-100">
